    ...
    internal static class TimelineCompatibilityHelper
    {
        internal static void PopulateTimeline()
        {
            ...
            TimelineCompatibility.AddInterpolableModelDynamic(
                ...
                id: "mainSkin",
                name: "Main Skin",
                interpolateBefore: (oci, parameter, leftValue, rightValue, factor) => parameter.UpdateBodyColor(Color.LerpUnclamped(leftValue, rightValue, factor), BodyColor.SkinMain),
            ...
            TimelineCompatibility.AddInterpolableModelDynamic(
                ...
                id: "subSkin",
                name: "Sub Skin",
                interpolateBefore: (oci, parameter, leftValue, rightValue, factor) => parameter.UpdateBodyColor(Color.LerpUnclamped(leftValue, rightValue, factor), BodyColor.SkinSub),
                interpolateAfter: null,
            ...
            TimelineCompatibility.AddInterpolableModelDynamic(
                ...
                id: "tan",
                name: "Tan Color",
                interpolateBefore: (oci, parameter, leftValue, rightValue, factor) => parameter.UpdateBodyColor(Color.LerpUnclamped(leftValue, rightValue, factor), BodyColor.SkinTan),
                interpolateAfter: null,

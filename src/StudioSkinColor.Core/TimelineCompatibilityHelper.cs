    ...
    internal static class TimelineCompatibilityHelper
    {
        internal static void PopulateTimeline()
        {
            ...
            TimelineCompatibility.AddInterpolableModelDynamic(
                ...
                id: "bustSoftness",
                name: "Bust Softness",
                interpolateBefore: (oci, parameter, leftValue, rightValue, factor) => parameter.SetBustValue(Mathf.LerpUnclamped(leftValue, rightValue, factor), Bust.Softness),
                interpolateAfter: null,
            ...
            TimelineCompatibility.AddInterpolableModelDynamic(
                ...
                id: "bustWeight",
                name: "Bust Weight",
                interpolateBefore: (oci, parameter, leftValue, rightValue, factor) => parameter.SetBustValue(Mathf.LerpUnclamped(leftValue, rightValue, factor), Bust.Weight),
                interpolateAfter: null,
            ...
            TimelineCompatibility.AddInterpolableModelDynamic(
                ...
                id: "hairColor1",
                name: "Hair Color 1",
                interpolateBefore: (oci, parameter, leftValue, rightValue, factor) => parameter.UpdateColorProperty(Color.LerpUnclamped(leftValue, rightValue, factor), ColorType.Base),
                interpolateAfter: null,
            ...
            TimelineCompatibility.AddInterpolableModelDynamic(
                ...
                id: "hairColor2",
                name: "Hair Color 2",
                interpolateBefore: (oci, parameter, leftValue, rightValue, factor) => parameter.UpdateColorProperty(Color.LerpUnclamped(leftValue, rightValue, factor), ColorType.Start),
                interpolateAfter: null,
            ...
            TimelineCompatibility.AddInterpolableModelDynamic(
                ...
                id: "hairColor3",
                name: "Hair Color 3",
                interpolateBefore: (oci, parameter, leftValue, rightValue, factor) => parameter.UpdateColorProperty(Color.LerpUnclamped(leftValue, rightValue, factor), ColorType.End),
                interpolateAfter: null,
            ...
            TimelineCompatibility.AddInterpolableModelDynamic(
                ...
                interpolateBefore: (oci, parameter, leftValue, rightValue, factor) => parameter.UpdateColorProperty(Color.LerpUnclamped(leftValue, rightValue, factor), ColorType.Gloss),
                interpolateAfter: null,
